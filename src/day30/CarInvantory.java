...
public class CarInvantory {
    public static void main(String[] args) {
        ...
        for (int i = 0; i <carInventory.length ; i++) {
           // if(carInventory[i].contains("Civic")){
            if(carInventory[i].equalsIgnoreCase("Honda-Civic")){
                System.out.println("Honda-Civic found at location: "+i);
            }

        }
//task 3 print make and model separately
